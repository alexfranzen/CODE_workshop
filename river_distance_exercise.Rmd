...
ARW<-st_read("/Users/alexfranzen/Desktop/CODE_workshop_GIS_materials/KiamichiHUCs/WBDHU2.shp") # this reads in the HUC 2 polygon shapefile for the Arkansas-Red-White River region. YOU WILL NEED TO CHANGE THE PATH NAME TO WHERE YOU STORE THE FILES ON YOUR COMPUTER! You will need to do this whenever there is a file upload. 
...
RedLittle<-st_read("/Users/alexfranzen/Desktop/CODE_workshop_GIS_materials/KiamichiHUCs/WBDHU6.shp")
...
KiamichiHUC8<-st_read("/Users/alexfranzen/Desktop/CODE_workshop_GIS_materials/KiamichiHUCs/WBDHU8.shp") # this reads the HUC 8 polygon (our HUC 8)
...
Kiamichi_NHDflowlines<-st_read("/Users/alexfranzen/Desktop/CODE_workshop_GIS_materials/Kiamichi_NHDFlowlines/Kiamichi_NHDFlowlines.shp")
...
Kiamichi_NHDflowlines_edited<-st_read("/Users/alexfranzen/Desktop/CODE_workshop_GIS_materials/Kiamichi_NHDFlowlines_edited/Kiamichi_NHDFlowlines_edited.shp")
...
Kiamichi_waterbodies<-st_read("/Users/alexfranzen/Desktop/CODE_workshop_GIS_materials/KiamichiHUCs/NHDWaterbody.shp")
...
mussel_beds<-st_read("/Users/alexfranzen/Desktop/CODE_workshop_GIS_materials/mussel_beds/mussel_beds.shp")

## Let's plot the whole thing!

watershed + geom_sf(data = Kiamichi_NHDflowlines_edited, color = "blue") + geom_sf(data = Kiamichi_waterbodies, color = "black", fill = "blue") + geom_sf(data = mussel_beds, color = "red", KiamichiHUCs = 17, size = 2) + xlab("Longitude") + ylab("Latitude") + annotation_scale(location = "br", width_hint = 0.4) + annotation_north_arrow(location = "bl", which_north = "true", pad_x = unit(0.0, "in"), pad_y = unit(0.2, "in"), style = north_arrow_fancy_orienteering) + coord_sf()
...
### If you need help fixing an issue, you might be able to find it in this documentation: https://cran.r-project.org/web/packages/riverdist/vignettes/riverdist_vignette.html
...
## Since connectedness is not detected for the Jack Fork Creek tributary, topologydots() shows the endpoints as red, or unconnected, so let's fix it. In this case, calling splitsegments() breaks the segments in the appropriate places, allowing for the network to be connected as it should be.

Kiamichi <- splitsegments(rivers=Kiamichi) # we can use the splitsegments function to fix our Kiamichi River network
...
mussel_beds<-pointshp2segvert(path = "/Users/alexfranzen/Desktop/CODE_workshop_GIS_materials/mussel_beds/mussel_beds.shp", layer = "mussel_beds", rivers = Kiamichi)
